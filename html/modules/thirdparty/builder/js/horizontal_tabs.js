...
(function ($) {
    ...
    Drupal.behaviors.horizontalTabs = {
        attach: function (context) {
            ...
            $(context).find('[data-horizontal-tabs-panes]').once('horizontal-tabs').each(function () {
                var $this = $(this).addClass('horizontal-tabs__panes tab-content');
                ...
                var tab_list = $('<ul class="horizontal-tabs__menu nav nav-tabs" role="tablist"></ul>');
                $this.wrap('<div class="horizontal-tabs clearfix"></div>').before(tab_list);

                // Transform each details into a tab.
                $details.each(function () {
                    var $that = $(this);
                    $that.find('> summary span.visually-hidden').remove();
                    ...
                    $that
                        ...
                        .attr('open', true)
                        .addClass('horizontal-tabs__pane tabpanel')
        ...
        focus: function () {
            this.details
                ...
                .each(function () {
                    ...
                    tab.details.hide();
                    tab.item.removeClass('is-selected active');
                })
                .end()
                .show()
                .siblings(':hidden.horizontal-tabs__active-tab')
                .val(this.details.attr('id'));
            this.item.addClass('is-selected active');
    ...
    Drupal.theme.horizontalTab = function (settings) {
        var tab = {};
        tab.item = $('<li class="horizontal-tabs__menu-item" tabindex="-1" role="presentation"></li>')
            .append(tab.link = $('<a href="#" data-toggle="tab"></a>')
